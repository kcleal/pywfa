...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/Users/kezcleal/Documents/Data/small_projects/pywfa/pywfa/WFA2-lib/wavefront/wavefront_attributes.h"
        ],
        "extra_compile_args": [
            "-Wno-sign-compare",
            "-Wno-unused-function",
...
#define __PYX_HAVE__pywfa__WFA_wrap
#define __PYX_HAVE_API__pywfa__WFA_wrap
/* Early includes */
...
#define __Pyx_MODULE_NAME "pywfa.WFA_wrap"
extern int __pyx_module_is_main_pywfa__WFA_wrap;
int __pyx_module_is_main_pywfa__WFA_wrap = 0;

/* Implementation of 'pywfa.WFA_wrap' */
...
static int __pyx_pymod_exec_WFA_wrap(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_WFA_wrap},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initWFA_wrap(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initWFA_wrap(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_WFA_wrap(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_WFA_wrap(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_WFA_wrap(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'WFA_wrap' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_WFA_wrap(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("WFA_wrap", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pywfa__WFA_wrap) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pywfa.WFA_wrap")) {
      if (unlikely(PyDict_SetItemString(modules, "pywfa.WFA_wrap", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pywfa/WFA_wrap.pyx":2
 * 
 * print('ye')             # <<<<<<<<<<<<<<
 */
  if (__Pyx_PrintOne(0, __pyx_n_s_ye) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pywfa.WFA_wrap", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pywfa.WFA_wrap");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
